...
def _build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument("--sims", type=positive_int_arg, default=300, help="Monte Carlo sims for SGP denominators.")
    common.add_argument("--horizon", type=positive_int_arg, default=20, help="Dynasty horizon years.")
