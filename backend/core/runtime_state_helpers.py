...
def calculate_league_dynasty_frame_cached(
    *,
    state: RuntimeStateHelpersState,
    teams: int,
    sims: int,
    ...
    return state.core_calculate_league_dynasty_frame(
        ensure_backend_module_path_fn=state._ensure_backend_module_path,
        excel_path=state.EXCEL_PATH,
        teams=teams,
        sims=sims,
...
def calculator_service_from_globals(*, state: RuntimeStateHelpersState) -> Any:
    return state.build_calculator_service(
        ...
        calculate_league_dynasty_frame_cached=state._calculate_league_dynasty_frame_cached,
