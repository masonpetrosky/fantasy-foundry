...
class RuntimeOrchestrationHelpers:
    ...
    def status_orchestration_context(self) -> StatusOrchestrationContext:
        ...
        return build_status_orchestration_context(
            ...
            rate_limit_activity_snapshot_getter=state._rate_limit_activity_snapshot,
            calculator_sync_rate_limit_per_minute=state.CALCULATOR_SYNC_RATE_LIMIT_PER_MINUTE,
            calculator_sync_auth_rate_limit_per_minute=state.CALCULATOR_SYNC_AUTH_RATE_LIMIT_PER_MINUTE,
            calculator_job_create_rate_limit_per_minute=state.CALCULATOR_JOB_CREATE_RATE_LIMIT_PER_MINUTE,
            calculator_job_create_auth_rate_limit_per_minute=state.CALCULATOR_JOB_CREATE_AUTH_RATE_LIMIT_PER_MINUTE,
            calculator_job_status_rate_limit_per_minute=state.CALCULATOR_JOB_STATUS_RATE_LIMIT_PER_MINUTE,
            calculator_job_status_auth_rate_limit_per_minute=state.CALCULATOR_JOB_STATUS_AUTH_RATE_LIMIT_PER_MINUTE,
            calculator_request_timeout_seconds=state.CALCULATOR_REQUEST_TIMEOUT_SECONDS,
