    ...
    def _start_year_roto_stats_by_entity(
        *,
        ...
        return state_module.core_start_year_roto_stats_by_entity(
            ...
            bat_data_raw=state_module.BAT_DATA_RAW,
            pit_data_raw=state_module.PIT_DATA_RAW,
            average_recent_projection_rows_fn=state_module._average_recent_projection_rows,
