            ...
            rows.append(
                {
                    ...
                    "RawYearValue": entry.get("raw_year_value"),
                    "AdjustedYearValue": entry.get("adjusted_year_value_before_discount"),
                    "AfterRiskValue": entry.get("after_risk_value"),
                    "DiscountFactor": entry.get("discount_factor"),
                    "DiscountedContribution": entry.get("discounted_contribution"),
                    "AgeRiskMultiplier": entry.get("age_risk_multiplier"),
                    "ProspectRiskMultiplier": entry.get("prospect_risk_multiplier"),
                    "MinorEligible": entry.get("minor_eligible"),
                    "NearZeroPlayingTime": entry.get("near_zero_playing_time"),
                    "CanMinorStash": entry.get("can_minor_stash"),
                    "CanIRStash": entry.get("can_ir_stash"),
                    "CanBenchStash": entry.get("can_bench_stash"),
                    "StashAdjustmentApplied": entry.get("stash_adjustment_applied"),
                    "StashMode": entry.get("stash_mode"),
                    "ProjectedAB": entry.get("projected_ab"),
                    "ProjectedIP": entry.get("projected_ip"),
                    "IRNegativePenalty": entry.get("ir_negative_penalty"),
                    "BenchNegativePenalty": entry.get("bench_negative_penalty"),
                    ...
                    "SelectedSide": points.get("selected_side"),
                    "HittingAssignmentSlot": points.get("hitting_assignment_slot"),
                    "PitchingAssignmentSlot": points.get("pitching_assignment_slot"),
                    "HittingAssignmentValue": points.get("hitting_assignment_value"),
                    "PitchingAssignmentValue": points.get("pitching_assignment_value"),
                    "HittingAssignmentReplacement": points.get("hitting_assignment_replacement"),
                    "PitchingAssignmentReplacement": points.get("pitching_assignment_replacement"),
                    "KeepDropValue": points.get("keep_drop_value"),
                    "KeepDropHoldValue": points.get("keep_drop_hold_value"),
                    "KeepDropKeep": points.get("keep_drop_keep", entry.get("keep_drop_keep")),
